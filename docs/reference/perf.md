...
| **F1d** | **テンプレートJIT (AArch64手書き±dynasmrt、Craneliftなし)** | 185+ MIPS | 🔬 | **2026-08-16採番 ([ADR-0022](../adr/0022-cpu-round3-before-gfx.md)、Tier 6の前)**。相場1,000〜2,000行 (DOSBox dynrec級)・追加数十kB=税ゼロ級。フロントはF1a〜F1c資産。Stage 2でブロック粒度 (案B、icount式切り直しで決定性無傷) とC14解禁、Stage 3でwasm解凍 |
