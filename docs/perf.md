...
### つぶす順番 (2026-08-10 夜 更新)

```
済み:    A1 A2(寝) B1 B2 B4 C2 C4 E1 E2 E6 — 13→66 MIPS、フルブート10秒達成
次:      B3 (ペア融合)。入れば出口条件 ~100 MIPS 圏
その後:  C5 → B5 → C1/C3 (プロファイルを取り直してから)
様子見:  D系・A3/A4。E5とF1は数字が出揃ってから判断
```
