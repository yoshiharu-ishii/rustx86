...
| | 窓命令数 | 壁時計 | MIPS | 指紋 |
|---|---|---|---|---|
| X窓 JIT off (交互2周) | 1284M | 22.7s | **56.5** | 296fabe8e823bd6c |
| X窓 JIT on | 1284M | 19.8〜20.2s | **64〜65** (+13-15%) | 同一 (ビット同一) |
| 参考 gcc窓 | 518M | — | off 80-83 / on 92-96 | |
